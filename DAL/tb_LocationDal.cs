...
namespace AutoRepair.DAL
{
    ...
    public partial class tb_LocationDataAccessLayer 
    {
		...
		{
			string sqlStr="insert into tb_Location([LocationParentId],[LocationGroupId],[LocationName],[LocationRemark],[LocationStatus],[LocationPath],[LocationGeographyTypeId],[LocationBusinessTypeId],[LocationShortName],[LocationSpellName],[OtherParentId]) values(@LocationParentId,@LocationGroupId,@LocationName,@LocationRemark,@LocationStatus,@LocationPath,@LocationGeographyTypeId,@LocationBusinessTypeId,@LocationShortName,@LocationSpellName,@OtherParentId) select @@identity";
			int res;
			SqlParameter[] _param={
			...
			_param[0].Value=_tb_LocationModel.LocationParentId;
			_param[1].Value=_tb_LocationModel.LocationGroupId;
			_param[2].Value=_tb_LocationModel.LocationName;
			_param[3].Value=_tb_LocationModel.LocationRemark;
			_param[4].Value=_tb_LocationModel.LocationStatus;
			_param[5].Value=_tb_LocationModel.LocationPath;
			_param[6].Value=_tb_LocationModel.LocationGeographyTypeId;
			_param[7].Value=_tb_LocationModel.LocationBusinessTypeId;
			_param[8].Value=_tb_LocationModel.LocationShortName;
			_param[9].Value=_tb_LocationModel.LocationSpellName;
			_param[10].Value=_tb_LocationModel.OtherParentId;
